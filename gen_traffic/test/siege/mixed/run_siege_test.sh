...
SIEGE_START_CMD="siege --quiet --log=./siege_30u_30M.log -c$START_USERS -d$REQ_DELAY -i -f urls.txt -t30M"
SIEGE_UPSCALE_CMD="siege --quiet --log=./siege_120u_10-20min.log -c120 -d$REQ_DELAY -i -f urls.txt -t10M"
SIEGE_DOWNSCALE_CMD="siege --quiet --log=./siege_60u_20-30min.log -c60 -d$REQ_DELAY -i -f urls.txt -t11M"
...
# SLEEP TO UPSCALE
echo -e "\nSleep 10min to scale users..." ; sleep 10m
...
# SLEEP TO DOWNSCALE
echo -e "\nSleep 10min to downscale users..." ; sleep 10m
